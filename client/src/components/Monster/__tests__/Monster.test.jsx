...
describe('Monster component', () => {
    it('should render the component', () => {
        // Arrange
        const { container } = render(<Monster data={data} />);

        // Assert
        expect(container).toMatchSnapshot();
    });

    it('should not render special abilities if there are none', () => {
        // Arrange
        const modifiedData = data;
        modifiedData.special_abilities = '';

        // Act
        render(<Monster data={modifiedData} />);

        // Assert
        expect(screen.queryByText('Special Abilities')).toBeNull();
    });

    it('should not render actions if there are none', () => {
        // Arrange
        const modifiedData = data;
        modifiedData.actions = '';
    ...
    it('should not render legendary actions if there are none', () => {
        // Arrange
        const modifiedData = data;
        modifiedData.legendary_actions = '';
